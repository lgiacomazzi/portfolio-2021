  ...
  return (
    <Link href="/#portfolio">
      <motion.a
        ...
        whileTap={{ scale: 0.98 }}
        className={styles.manifestoScroll}
      >
        <ScrollDown />
      </motion.a>
    </Link>

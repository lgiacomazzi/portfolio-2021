...
import {
  ExperienceContainer,
  ExperienceBubble,
} from "../components/ExperienceBubble";
...
export default function About() {
  ...
  const Paragraph = ({ children }) => <p className="text-body">{children}</p>;
        ...
        <div className="container">
          ...
          <div className="row mb-2">
            <div className="col-lg-6 d-flex flex-column m-auto text-center align-items-center">
              ...
              />
              <h2 className="mt-2">luciano giacomazzi</h2>
              <SmallText>
              ...
              <div className="mt-2 d-flex flex-column text-center align-items-center">
                ...
                <div className="mt-3 d-flex flex-column text-center justify-space-between align-items-center">
                  <Paragraph>
                    <InlineLink href="mailto:lucianogiacomazzi@gmail.com">
                      lucianogiacomazzi@gmail.com
                    </InlineLink>
                  </Paragraph>
                  <Paragraph>
                    <InlineLink href="tel:+ 55 51 99829 0763">
                      + 55 51 99829 0763
                    </InlineLink>
                  </Paragraph>
                  <Paragraph>
                    <InlineLink href="https://www.linkedin.com/in/lgiacomazzi/">
                      Linked In
                    </InlineLink>
                  </Paragraph>
          ...
          <ExperienceContainer>
            <ExperienceBubble
              content={{
                title: about("role_05"),
                company: "Sicredi",
                period: "Jan. 2023 - Hoje",
                location: "Porto Alegre, Rio Grande do Sul, Brasil",
                image: "",
                description: about("description_role_05"),
              }}
            />
            <ExperienceBubble
              content={{
